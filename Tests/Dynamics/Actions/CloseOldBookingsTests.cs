...
{
    [TestClass]
    public class CloseOldBookingsTests : DynamicsTestBase<SB.Actions.ActionTracking>
    {
        [TestMethod]
        public void Successful()
        {
            ...
            {
                new KeyValuePair<string, object>("ActionName", ActionNames.ActionTrackingNames.CloseOldBookings),
